...
type K8sRequirements struct {
	...
	TotalMemory   string   `yaml:"total_memory,omitempty" json:"total_memory,omitempty" validate:"omitempty,bytes"`
}

type K8sPVClaim struct {
	Name        string   `yaml:"name" json:"name" validate:"required"`
	Storage     string   `yaml:"storage,omitempty" json:"storage,omitempty" validate:"omitempty,bytes"`
